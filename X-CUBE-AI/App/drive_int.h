...
#ifndef AI_DRIVE_INT_H
#define AI_DRIVE_INT_H
#pragma once
...
/******************************************************************************/
#define AI_DRIVE_INT_MODEL_NAME          "drive_int"
#define AI_DRIVE_INT_ORIGIN_MODEL_NAME   "drive_int"

/******************************************************************************/
#define AI_DRIVE_INT_ACTIVATIONS_ALIGNMENT   (4)



/******************************************************************************/
#define AI_DRIVE_INT_IN_NUM        (1)
#define AI_DRIVE_INT_IN { \
  AI_BUFFER_OBJ_INIT(AI_BUFFER_FORMAT_U8, 64, 64, 3, 1, NULL), \
}
#define AI_DRIVE_INT_IN_SIZE { \
  AI_DRIVE_INT_IN_1_SIZE, \
}
#define AI_DRIVE_INT_IN_SIZE_BYTES { \
  AI_DRIVE_INT_IN_1_SIZE_BYTES, \
}
#define AI_DRIVE_INT_IN_1_HEIGHT      (64)
#define AI_DRIVE_INT_IN_1_WIDTH       (64)
#define AI_DRIVE_INT_IN_1_CHANNEL     (3)
#define AI_DRIVE_INT_IN_1_SIZE        (64 *  64 *  3)
#define AI_DRIVE_INT_IN_1_SIZE_BYTES  (AI_DRIVE_INT_IN_1_SIZE * 1)

/******************************************************************************/
#define AI_DRIVE_INT_OUT_NUM       (1)
#define AI_DRIVE_INT_OUT { \
  AI_BUFFER_OBJ_INIT(AI_BUFFER_FORMAT_U8, 1, 1, 3, 1, NULL), \
}
#define AI_DRIVE_INT_OUT_SIZE { \
  AI_DRIVE_INT_OUT_1_SIZE, \
}
#define AI_DRIVE_INT_OUT_SIZE_BYTES { \
  AI_DRIVE_INT_OUT_1_SIZE_BYTES, \
}
#define AI_DRIVE_INT_OUT_1_CHANNEL     (3)
#define AI_DRIVE_INT_OUT_1_SIZE        (3)
#define AI_DRIVE_INT_OUT_1_SIZE_BYTES  (AI_DRIVE_INT_OUT_1_SIZE * 1)

/******************************************************************************/
#define AI_DRIVE_INT_N_NODES (10)
 ...
 * @ref ai_drive_int_create. Both the activations memory buffer 
 ...
 * using @ref ai_drive_int_get_error
 */
AI_API_ENTRY
 ...
 * header generated by the code generation tool. See AI_DRIVE_INT_*
 * defines into file @ref drive_int.h for all network sizes defines
 *
 * @param network an opaque handle to the network context
 ...
 */
AI_API_ENTRY
ai_i32 ai_drive_int_forward(
  ai_handle network, const ai_buffer* input);

AI_API_DECLARE_END

#endif /* AI_DRIVE_INT_H */
